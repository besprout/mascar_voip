...
<body>
	...
	<article class="_demo--content base--article">
		...
		<div>
			<div id="speakDiv"></div>
			<input id="btnDialog" type="button" value="update dialog" onclick="updateDialog()" />
			<input id="btnSpeak" type="button" value="Speak dialog" onclick="speak()" />
			<img id="updateLoading" src="images/loading.gif" style="display:none" />
